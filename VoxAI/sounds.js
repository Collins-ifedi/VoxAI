export class SoundManager {
  constructor() {
    ...
    // Don't initialize sounds in constructor - wait for first use
  ...
  playKeystroke() {
    ...
    if (this.sounds.keystroke) this.sounds.keystroke()
  }

  playMessageSent() {
    if (!this.initialized) this.init()
    if (this.sounds.messageSent) this.sounds.messageSent()
  }

  playMessageReceived() {
    if (!this.initialized) this.init()
    if (this.sounds.messageReceived) this.sounds.messageReceived()
  }
